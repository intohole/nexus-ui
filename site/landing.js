  ...
  const app = createApp({
    data() {
      return {
        ...
        busy: false,
        quickCode: [
          '<link rel="stylesheet" href="https://songguokr.com/nexus-ui/v2.10.59/css/nexus-all.css">',
          '<script src="https://songguokr.com/nexus-ui/v2.10.59/vendor/vue.global.prod.js"><\/script>',
          '<script src="https://songguokr.com/nexus-ui/v2.10.59/js/nexus-all.js"><\/script>',
          '<script src="https://songguokr.com/nexus-ui/v2.10.59/js/components/nux-button.js"><\/script>'
        ],
        compCats: [
