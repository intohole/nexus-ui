  ...
  const app = createApp({
    data() {
      return {
        ...
        busy: false,
        quickCode: [
          '<link rel="stylesheet" href="https://songguokr.com/nexus-ui/v2.10.55/css/nexus-all.css">',
          '<script src="https://registry.npmmirror.com/vue/3.4.21/files/dist/vue.global.prod.js"><\/script>',
          '<script src="https://songguokr.com/nexus-ui/v2.10.55/js/nexus-all.js"><\/script>',
          '<script src="https://songguokr.com/nexus-ui/v2.10.55/js/components/nux-button.js"><\/script>'
        ],
        compCats: [
