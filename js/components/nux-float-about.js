(function() {
  ...
  function init() {
    ...
    btn.href = prefix + '/static/about.html';
    ...
    btn.title = '关于我们';
    btn.style.cssText = 'position:fixed;right:20px;bottom:' + bottom + ';height:44px;padding:0 16px;border-radius:22px;background:' + accent + ';color:#fff;display:flex;align-items:center;justify-content:center;text-decoration:none;box-shadow:0 2px 12px rgba(0,0,0,0.15);z-index:99;opacity:.8;transition:all .2s;gap:0';
